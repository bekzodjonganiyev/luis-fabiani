...
const gallery = (): ProductImage[] => [
  { src: "/images/studio_warm.jpg", view: "three_quarter" },
  { src: "/images/studio_grey.jpg", view: "profile" },
...
export const PRODUCTS: ProductRecord[] = [
  ...
  },
  {
    ...
    images: [{ src: "/images/studio_grey.jpg", view: "three_quarter" }, ...gallery().slice(1)],
  ...
  },
  {
    ...
    fit: "standard",
    occasions: ["casual"],
    images: [{ src: "/images/studio_cream.jpg", view: "three_quarter" }, ...gallery().slice(1)],
    addons: ["cream-black"],
  ...
  },
  {
    ...
    fit: "standard",
    occasions: ["office", "casual"],
    images: [{ src: "/images/studio_stone.jpg", view: "three_quarter" }, ...gallery().slice(1)],
    addons: ["cream-black"],
  ...
  },
  {
    ...
    fit: "standard",
    occasions: ["office", "casual"],
    images: [{ src: "/images/studio_warm.jpg", view: "three_quarter" }, ...gallery().slice(1)],
    addons: ["cream-black", "laces"],
  ...
  },
  {
    ...
    fit: "standard",
    occasions: ["wedding"],
    images: [{ src: "/images/patent.jpg", view: "three_quarter" }, ...gallery().slice(1)],
    addons: ["cream-black"],
  ...
  },
  {
    ...
    fit: "standard",
    occasions: ["casual"],
    images: [{ src: "/images/suede.jpg", view: "three_quarter" }, ...gallery().slice(1)],
    addons: ["cream-black"],
  ...
  },
  {
    ...
    images: [{ src: "/images/leather_dark.jpg", view: "three_quarter" }, ...gallery().slice(1)],
    addons: ["cream-black"],
